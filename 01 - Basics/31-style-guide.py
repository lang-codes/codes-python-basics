# HEAD
# Describes the usage of python code style guide
# DESCRIPTION
# The Python PEP style guide from the Python repository
# RESOURCES
# Github link for updated version - last updated details below: 20-Jan-2020
