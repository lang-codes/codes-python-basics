...
# DESCRIPTION
# Describes the main script file the packge initialises
#       and it is not necessary to have a main script 
#       initializer file for a package. Change this in setup.py 
#       based on need of keeping or removing the file
# RESOURCES
# 
